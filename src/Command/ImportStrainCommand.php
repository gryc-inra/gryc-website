...
use App\Entity\BlastFile;
use App\Entity\Chromosome;
use App\Entity\DnaSequence;
...
class ImportStrainCommand extends ContainerAwareCommand
{
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        $speciesList = $this->em->getRepository('App:Species')->findAll();
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== $this->em->getRepository('App:Strain')->findOneBy(['name' => $data['name']])) {
