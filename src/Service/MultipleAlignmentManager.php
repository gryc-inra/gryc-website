...
class MultipleAlignmentManager
{
    ...
    public function getLastAlignment()
    {
        ...
        $multipleAlignment = $this->em->getRepository('App:MultipleAlignment')->findOneById($lastMultipleAlignmentId);
    ...
    {
        return $this->em->getRepository('App:MultipleAlignment')->findOneById($id);
    }

    /**
     * Save Multiple alignment.
     */
    public function save(MultipleAlignment $multipleAlignment): MultipleAlignment
    {
